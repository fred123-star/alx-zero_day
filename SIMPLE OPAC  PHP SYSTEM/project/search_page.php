   ...
   <form action="" method="post">
      <input type="text" name="search" placeholder="search books..." class="box">
        <select name="user_type" class="box">
           ...
           <option value="admin">ISBN</option>
           <option value="admin">author</option>
           <option value="admin">keyword</option>
...
<section class="products" sty   le="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="price"><?php echo $fetch_product['price']; ?>bks</div>
