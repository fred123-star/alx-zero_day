...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" name="price" class="box" placeholder="enter book shelve number" required>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="price">shelve<?php echo $fetch_products['price']; ?>z</div>
      ...
      <?php
         ...
         echo '<p class="empty">no such book  added yet!</p>';
      }
      ?>
   </div>
